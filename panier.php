		...
		<div class="millieu">
			<div class="pan">
				...
				<tr>
					...
					echo $resultat." €";
					?>
					<button type="button" class="valid" onclick="location.href = 'validpanier.php?nom=$value&red=panier.php'">Valider mon panier</button>
					<button type="button" class="valid" onclick="location.href = 'viderpanier.php?nom=$value&red=panier.php'">Vider mon panier</button>
					</tr>
					<?php echo $_GET[err]; ?>
					</p>
					</tr>
